package folha.rodrigo.login_auth_api.infra.security;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://localhost:4200");  // Use o domínio do seu frontend, ex: "http://localhost:3000"
